      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Have questions or want to discuss a project? Our team is ready to help.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">17 Lagos Avenue, East Legon - Accra</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 text-blue-600 mt-1">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">+233 (203) 817-131</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 text-blue-600 mt-1">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">sales@unixtron.tech</p>
                  </div>
                </div>
              </div>

              <div className="mt-12">
                <h3 className="text-lg font-medium mb-4 text-gray-900">Connect With Us</h3>
                <div className="flex space-x-6">
                  ...
                  <a 
                    ...
                    className="text-[#1877F2] hover:text-[#1877F2]/90 transition-colors"
                    aria-label="Facebook"
                  >
                  ...
                  {/* WhatsApp */}
                  <a 
                    href="https://wa.me/233203817131" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-[#25D366] hover:text-[#25D366]/90 transition-colors"
                    aria-label="WhatsApp"
                  >
                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-[#0A66C2] hover:text-[#0A66C2]/90 transition-colors"
                    aria-label="LinkedIn"
                  >
                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
